...
function init(port) {
    ...
    var doc											// will reference the document representing the XML structure
    , app											// will reference the HTTP server
    , applicationServer = {ip: 'mandelbrot.e.ujf-grenoble.fr', port: 8000}	// Application server IP and port that is in charge of optimizing nurses' travels, by default, this server
    ;
...
var port					= params.port       || "8080"
  ...
  , applicationServerPort	= params.remotePort || port
  ;
