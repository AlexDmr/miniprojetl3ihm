            ...
            if(doc) {
                ...
                for(let infirmierXML of doc.querySelectorAll( "infirmiers > infirmier" )) {
                    let infirmierJS : InfirmierInterface = {
                        ...
                        prenom  : (node=infirmierXML.querySelector("prenom"))?node.textContent:"",
                ...
                for(let patientXML of doc.querySelectorAll( "patients > patient" )) {
                    ...
                    let patientJS : PatientInterface = {
                        prenom                  : (node=patientXML.querySelector("prenom"))?node.textContent:"",
                        ...
                        numeroSecuriteSociale   : patientXML.querySelector("numero").textContent,
                        adresse                 : {
                            ...
                            numero      : (node=patientXML.querySelector("adresse > numero")    )?node.textContent:"",
                            etage       : (node=patientXML.querySelector("adresse > etage")     )?node.textContent:""
                        }
                    };
